...
typedef enum { PREPARE_SUCC, PREPARE_UNRECOGNIZED_STMT, PREPARE_SYNTAX_ERROR, PREPARE_STR_TOO_LONG } PrepareResult;
...
PrepareResult prepare_insert(InputBuffer* buf, Statement* stmt) {
...
PrepareResult prepare_stmt(InputBuffer* buf, Statement *stmt) {
